...
st.markdown('<p class="subtitle">Система управления командой и сбора утренних планов</p>', unsafe_allow_html=True)
...
<div class="info-panel">
    ...
    <p style="color: var(--text-secondary); margin-bottom: 0;">
        ...
        ⏰ <strong>Время рассылки:</strong> 9:30 (UTC+6)<br>
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if scheduler_info.get("next_morning_questions"):
                    ...
                    st.warning("⚠️ Задача утренней рассылки не найдена")
...
with st.sidebar:
    ...
    <div class="sidebar-content">
        ...
        <div style="color: var(--text-secondary); font-size: 0.9rem; line-height: 1.6;">
            ...
            • 9:30 - бот отправляет вопросы<br>
            • 10:30 - генерация сводки
        </div>
