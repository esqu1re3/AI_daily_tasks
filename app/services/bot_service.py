...
class BotService:
    ...
    def _handle_start_command(self, message, bot, db):
        ...
        if db_user and db_user.is_verified:
            bot.reply_to(
                message,
                "👋 Привет! Вы подключены к системе сбора вечерних планов команды.\n\n"
                "🌅 Каждый вечер в 17:30 я буду спрашивать у вас планы на день.\n\n"
                "🔹 Просто отвечайте на мои вечерние сообщения своими рабочими планами.\n\n"
    ...
    def _activate_user_with_token(self, activation_token, telegram_user, db, bot, message):
        ...
        try:
            ...
            welcome_message = f"🎉 Добро пожаловать в группу '{target_group.name}', {welcome_name}!\n\n" \
                            ...
                            f"🌅 Каждый вечер в {schedule_time} ({target_group.timezone}) я буду спрашивать у вас планы на день.\n" \
                            "Просто отвечайте на мои сообщения своими рабочими планами.\n\n" \
