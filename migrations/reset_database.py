...
def create_default_group():
    """Создает группу по умолчанию для обратной совместимости (ОТКЛЮЧЕНО)"""
    ...
    print("ℹ️ Автоматическое создание группы по умолчанию отключено")
    print("💡 Создайте группы через админ-панель: вкладка 'Группы' → 'Создать новую группу'")
    return True
